...
module.exports = {
    ...
    async execute(interaction) {
        ...
        ///////////////////////////////////////////////////
            ...
            const channel = await createTicket(interaction.guild, settings.category, interaction.user, settings.staff_role, embed, [row]);
        ...
        ///////////////////////////////////////////////////
            ...
            const embed = new EmbedBuilder()
                ...
                .setDescription(
                    user
                        ? `*You are currently subscribed! Your subscription expires <t:${Math.floor(
                              user.expiry_date.getTime() / 1000
                          )}:R>.*`
