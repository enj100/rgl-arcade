...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const embed = new EmbedBuilder()
            ...
            .setDescription(`*⭐ Items will be converted into Tokens and credited into your wallet balance automatically.*\n\n${reward}`)
            .setColor("FF0000");
        ...
        const checkItems = new ActionRowBuilder().addComponents(
            new ButtonBuilder().setCustomId("wheel_check_items").setLabel("Check Items").setStyle(ButtonStyle.Secondary).setEmoji("🛞")
        );
        ...
        await logToChannel(
            `🛞 User ${interaction.user} just spun the wheel and won **${item.item_name}** worth **${item.item_value} RGL-Tokens**!`,
