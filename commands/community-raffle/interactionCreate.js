...
module.exports = {
    ...
    async execute(interaction) {
        if (interaction.isChatInputCommand()) return;
            ...
            const modal = new ModalBuilder().setCustomId(`community_raffle_edit_embed_submit-${raffleId}`).setTitle("Edit Raffle Embed");
            ...
            const modal = new ModalBuilder().setCustomId(`community_raffle_buy_ticket_submit-${raffleId}`).setTitle("Buy Raffle Tickets");
